...
async def create_post(post: schemas.PostCreate, token: str, db: Session = Depends(database.get_db), request: Request = None):
    """
    ...
    Raises:
        HTTPException: If the token is invalid or payload size exceeds the limit.
    """
